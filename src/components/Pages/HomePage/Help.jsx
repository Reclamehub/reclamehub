...
export const Help = () => {
    ...
    return (
        <Box paddingTop={"50px"} paddingBottom={"50px"} borderTop={"4px solid white"} borderBottom={"4px solid white"} bg={useColorModeValue('white', '#1f1f1f')}>
            <Heading as="h2" className="help-heading" fontSize={{ base: "6vw", sm: "3.5vw", md: "3.5vw", lg: "3.5vw", xl: "3.5vw" }}>CLIENT <span style={{ color: "#F47721" }}>WE'VE HELPED </span>GROW</Heading>
            <br />
            <br />
