...
return (<Box fontFamily={"poppins"}>
       ...
       <Text fontWeight={"550"} mt="20px" mb="20px" fontSize= {{base:"10px",sm:"10px",md:"16px",lg:"20px",xl:"20px"}}>"WE'RE YOUNG, WE'RE PASSIONATE AND WE'RE ENTHUSIAST TO TRANSFORM YOUR BRAND IN THIS DIGITAL WORLD."</Text>
        
        <br />
        <Flex color="white"  m="auto" flexDirection={{base:"column",sm:"column",md:"row",lg:"row",xl:"row"}} justifyContent={{base:"center",sm:"center",md:"space-around",lg:"space-around",xl:"space-around"}} w={{base:"80%",sm:"80%",md:"90%",lg:"80%",xl:"80%"}} >
        ...
        <Box w={{base:"100%",sm:"80%",md:"80%",lg:"40%",xl:"40%"}}    p="10px"  >
            ...
            <Box backgroundColor="#F47721" w={{base:"100%",sm:"80%",md:"65%",lg:"55%",xl:"55%"}}  m="auto" borderRadius={"20px"}  padding={{base:"10px 10px 10px 10px",sm:"10px 10px 10px 10px",md:"10px 10px 10px 10px",lg:"50px 50px 50px 50px",xl:"50px 50px 50px 50px"}} fontWeight={"550"} fontSize={{base:"10px",sm:"10px",md:"12px",lg:"16px",xl:"16px"}} lineHeight={"2.5em"} marginTop={{base:"10px",sm:"00px",md:"80px",lg:"100px",xl:"120px"}}>
