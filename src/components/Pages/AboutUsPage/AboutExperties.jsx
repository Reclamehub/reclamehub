...
<Box>
    <Flex  w="85%" m="auto" flexDirection={{base:"column",sm:"column",md:"row",lg:"row",xl:"row"}} justifyContent={{base:"center",sm:"center",md:"space-around",lg:"space-around",xl:"space-around"}}>
        ...
        <Box display={"flex"} justifyContent={"center"}>
            <Image boxSize={{base:"200px",sm:"200px",md:"240px",lg:"350px",xl:"350px"}}  src="gif1.gif" alt="social media managment"  /></Box>
            <Box> <Text color="#FF7721" fontWeight={"bold"} fontSize={"20px"}> SOCIAL MEDIA MANAGMENT</Text></Box>
        </Box>
  
        <Box border="1px solid gray" p="15px" m="10px" borderRadius={"10px"} > 
        <Box display={"flex"} justifyContent={"center"}>
            <Image boxSize={{base:"200px",sm:"200px",md:"240px",lg:"350px",xl:"350px"}} src="gif3.gif" alt="graphic designing" />
        </Box>
        ...
        <Box border="1px solid gray" p="15px" m="10px" borderRadius={"10px"}>
        <Box display={"flex"} justifyContent={"center"} >
            <Image boxSize={{base:"200px",sm:"200px",md:"240px",lg:"350px",xl:"350px"}} src="gif2.gif" alt="web design and development" /></Box>
