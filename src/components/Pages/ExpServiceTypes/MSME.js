 ...
 export const MSME = () => {
  ...
  <Container className='d-flex flex-column justify-content-start align-items-start inner_box '>
        ...
        <div className='exp_iso_text_div'>
          ...
          <div className='vector_text_flex'>
            <img className="msme_vector"src="msmeVector.png"/>
            <p className='mt-3'>Go to the official website Udyam registration portal: <span style={{color:"#f47721"}}> <Link to= "https://udyamregistration.gov.in/Government-India/Ministry-MSME-registration.htm">Link</Link></span></p>
            </div>

            <div className='vector_text_flex'>
            <img className="msme_vector"src="msmeVector.png"/>
            <p className='mt-3'>Create an account. Enter your details in the application form Including your Aadhar number, applicant name, and mobile number.</p>
           </div>
           
           <div className='vector_text_flex'>
            <img className="msme_vector"src="msmeVector.png"/>
            <p className='mt-3'>Enter the OTP to validate the verification process from the registered contact number. </p>
            </div>
            
            <div className='vector_text_flex'>
            <img className="msme_vector"src="msmeVector.png"/>
            <p className='mt-3'>Fill out the registration form. Where you need to provide the following information:</p>
            </div>
            <ul className='msme_ul'>
            <li>Company name</li>
           ...
           <div className='vector_text_flex'>
            <img className="msme_vector"src="msmeVector.png"/>
            <p className='mt-3'>Submit the registration form.<br/>Once the e-certification process is complete, the same shall be intimated to the business owner's contact.</p>
        </div>
        </div>
    </Container>
    </Container>
